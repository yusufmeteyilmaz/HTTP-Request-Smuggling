...
![[Images/2.5- Little bit coding/wireshark_1.png]]
...
![[Images/2.5- Little bit coding/wireshark_2.png]]
...
![[Images/2.5- Little bit coding/wireshark_5.png]]
...
Note:
If we close connection before server send RespC, [[Images/2.5- Little bit coding/wireshark_1.png]].
If we close connection after server send RespC, [[Images/2.5- Little bit coding/wireshark_5.png]].
...
Now you can move on to [[3- HTTP Request Smuggling]]